...
const plans = [
  {
    name: 'スタータープラン',
    price: '¥9,800',
    features: ['1つのAIタレント', '基本的な会話機能', '月100時間の利用制限', 'メールサポート'],
  },
  {
    name: 'プロフェッショナルプラン',
    price: '¥29,800',
    features: ['3つのAIタレント', '高度な会話機能', '無制限の利用時間', '優先サポート', 'カスタマイズオプション'],
  },
  {
    name: 'エンタープライズプラン',
    price: 'お問い合わせ',
    features: ['無制限のAIタレント', '最先端の会話機能', '専用サポートチーム', 'フルカスタマイズ', 'API連携'],
  },
]
